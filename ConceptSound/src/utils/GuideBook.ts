...
async function getGuidePages() {
    return [
        ...
        await createGuidePage("typy stron",
            ...
            "@w ten sposób!\n" +
            "2) nutowy: zacznij pisać nuty nazwami literowymi przed \"|]\" i obserwuj efekty - nad ekranem warsztatu. Aby dowiedzieć się więcej sprawdź notację ABC.js.\n" +
